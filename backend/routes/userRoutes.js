...
const {sendRequest,acceptRequest,getSuggestion,getConnections,BlockUser,unBlockUser,removeUser,getNotification,rejectRequest} = require('../controllers/userController')
