...
const sendMessage = async (req, res) => {
    ...
    console.log("user and rec data ",rec_id );
...
const getChatMessageFile = async (req, res) => {
    ...
    try {
        ...
        const imagePath = path.join(__dirname, `../public/chatFiles/${chatId}/${fileName}`);
...
module.exports = { sendMessage ,editmessage,deleteMessage,getMessages,getChatMessageFile};
